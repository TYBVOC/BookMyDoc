        ...
        <Grid container spacing={4} sx={{ mt: 3 }}>
          <Grid item xs={12} md={4}>
            <Card sx={{ backgroundColor: 'primary.main', color: 'white' }}>
              <CardContent>
                <Typography variant="h6" fontWeight={600}>EFFICIENCY:</Typography>
          ...
          <Grid item xs={12} md={4}>
            <Card>
              <CardContent>
                <Typography variant="h6" fontWeight={600}>CONVENIENCE:</Typography>
                <Typography variant="body2">
          ...
          <Grid item xs={12} md={4}>
            <Card>
              <CardContent>
                <Typography variant="h6" fontWeight={600}>PERSONALIZATION:</Typography>
                <Typography variant="body2">
